...
def home():
    ...
    if request.method == 'POST':
        ...
        if uploaded_file.filename:
            ...
            model_path = os.path.join(SCRIPT_DIR, "digits_recognition_cnn_model.h5")
            ...
            predicted_number, _, resized_image = classify_digit(model, resized_image)

            result = f'The digit is probably a {predicted_number}.'
